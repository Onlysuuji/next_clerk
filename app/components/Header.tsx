...
export default function Header() {
    ...
    return (
        <nav className={`fixed top-0 left-0 right-0 z-50 flex h-20 justify-between shadow-[0_0_64px_0_rgba(0,0,0,0.07)] border-b-4 border-gray-100 bg-white ${isWordListPage ? 'w-[768px] mx-auto' : 'w-full'}`}>
